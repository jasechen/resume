...
git subtree add --prefix=public git@github.com:${GIT_ACCOUNT}/${GIT_REPOSITORY}.git gh-pages --squash

# Pull down the file we just committed. This helps avoid merge conflicts
git subtree pull --prefix=public git@github.com:${GIT_ACCOUNT}/${GIT_REPOSITORY}.git gh-pages
